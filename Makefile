...
test_newton1D:
	gfortran -o ./test_newton1D.o ./functions/whatever_function.f90 ./modules/module_linear_equations.f90  ./modules/module_newton_raphson.f90 ./test/newton_test1D.f90
